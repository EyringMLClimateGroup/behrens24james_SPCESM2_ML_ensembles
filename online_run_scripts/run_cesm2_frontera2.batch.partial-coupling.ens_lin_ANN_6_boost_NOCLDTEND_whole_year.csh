#!/bin/csh
#
# this code reproduces the \overline{DNN}-CESM hybrid simulation for given model txt files and initial conditions of CESM2, author: Sungduk Yu, Gunnar Behrens
# run example:
# ./run_cesm2_frontera2.batch.partial-coupling.ens_lin.csh "'/models/online_models/ANN_1/ANN_1_CRM_lin_model.h5.txt','/models/online_models/ANN_2/ANN_2_CRM_lin_model.h5.txt','/models/online_models/ANN_3/ANN_3_CRM_lin_model.h5.txt','/models/online_models/ANN_4/ANN_4_CRM_lin_model.h5.txt','/models/online_models/ANN_5/ANN_5_CRM_lin_model.h5.txt','/models/online_models/ANN6/ANN_6_CRM_lin_model_boost.txt','/models/online_models/ANN_7/ANN_7_CRM_lin_model.h5.txt'" 2013-02-01
...
set run_time       = 08:00:00
set queue          = regular
set account        = UYLE0025
set pcount         = 1024
set pelayout       = /glade/work/gbehrens/CESM2-neuralnet-UCI/cheyenne/pelayout_cheyenne01.xml
...
setenv CASE        CESM2_ANNs_ncpl-48_spcam-dt-20_${REFDATE}_partial-coupling-NOCLDTEND_ens_lin_ANN_06_boost_whole_year
...
echo "directories are defined"
## ====================================================================
#   define directories <Please make sure the directories are correct>
## ====================================================================

setenv MACH      cheyenne
setenv CCSMROOT  /glade/work/gbehrens/$CCSMTAG
setenv CODEDIR   /glade/work/gbehrens/CESM2-neuralnet-UCI
...
#  FKB file paths
## ====================================================================
echo "check FKB files"

set cb_inp_sub   = /models/online_models/norm_files/inp_sub.txt
set cb_inp_div   = /models/online_models/norm_files/inp_div.txt
set cb_out_scale = /models/online_models/norm_files/out_scale_CRM.txt
