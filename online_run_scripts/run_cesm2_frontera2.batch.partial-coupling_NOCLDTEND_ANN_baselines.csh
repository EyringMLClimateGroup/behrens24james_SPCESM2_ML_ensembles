#!/bin/csh
#
# this code reproduces the hybrid simulations of CESM2 with individual models
# run example:
...
setenv CASE        CESM2_ANN_lin_ncpl-48_spcam-dt-20_${REFDATE}_partial-coupling-NOCLDTEND_${ANN}_whole_year #ALL-surf, ALL-atm, ALL-all
...
setenv PTMP      $TMPDIR/cesm2_scratch/ANN_baselines_lin_boost_whole_year
...
#  FKB file paths
## ====================================================================
set cb_fkb_model = /models/online_models//${ANN}/${ANN}_CRM_lin_model.h5.txt #have to adjust file name for ANN_6_boost
