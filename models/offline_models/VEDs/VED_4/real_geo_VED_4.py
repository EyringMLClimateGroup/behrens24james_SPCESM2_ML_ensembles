"""
train and test script for VED 4 
author: G.Behrens
"""
...
csv_logger = CSVLogger('real_geography/VEDs/VED_4/VED_4.csv')
...
# save VED 4 model files 
np.save('real_geography/VEDs/VED_4/VED_4',test_mse)
VED.save_weights('real_geography/VEDs/VED_4/VED_4_weights.h5')
VED.save_weights('real_geography/VEDs/VED_4/VED_4.tf')
VED.save_model('real_geography/VEDs/VED_4/VED_4_model.h5')
