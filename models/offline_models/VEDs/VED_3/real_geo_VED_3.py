"""
train and test script of VED 3
author: G. Behrens
...
# transform vertical axis in pressure coords 
...
csv_logger = CSVLogger('real_geography/VEDs/VED_3/VED_3.csv')
...
# save VED files
np.save('real_geography/VEDs/VED_3/VED_3',test_mse)
VED.save_weights('real_geography/VEDs/VED_3/VED_3_weights.h5')
VED.save_weights('real_geography/VEDs/VED_3/VED_3.tf')
VED.save_model('real_geography/VEDs/VED_3/VED_3_model.h5')
