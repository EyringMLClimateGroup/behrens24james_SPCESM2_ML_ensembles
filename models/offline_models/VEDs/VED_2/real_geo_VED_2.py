"""
train and test script for VED 2 
author: G.Behrens
...
# define some characterizing shapes
...
#determine pressure levles based on hybrid coords 
...
# defining validation data consistingconsisting of 7 consecutive days from all months of the second year of SPCESM simulations
...
with strategy.scope():
    ...
    outputs_A = Dense(104,activation='linear')(outputs_1) # tend. terms linear activated
    outputs_B = Dense(9,activation='relu')(outputs_1) # positively determined rad fluxes relu activated
...
# save history of VED training
callback_lr=LearningRateScheduler(schedule,verbose=1)
csv_logger = CSVLogger('real_geography/VEDs/VED_2/VED_2.csv')
...
# load test set and compute test_mse
...
# save VED files
np.save('real_geography/VEDs/VED_2/VED_2',test_mse)
VED.save_weights('real_geography/VEDs/VED_2/VED_2_weights.h5')
VED.save_weights('real_geography/VEDs/VED_2/VED_2.tf')
VED.save_model('real_geography/VEDs/VED_2/VED_2_model.h5')
