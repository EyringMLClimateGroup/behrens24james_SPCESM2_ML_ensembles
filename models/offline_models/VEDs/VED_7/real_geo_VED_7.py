...
from cbrain.data_generator import DataGenerator
# transform vertical coords into pressure level 
...
csv_logger = CSVLogger('real_geography/VEDs/VED_7/VED_7.csv')
...
np.save('real_geography/VEDs/VED_7/VED_7',test_mse)
VED.save_weights('real_geography/VEDs/VED_7/VED_7_weights.h5')
VED.save_weights('real_geography/VEDs/VED_7/VED_7.tf')
VED.save_model('real_geography/VEDs/VED_7/VED_7_model.h5')
