"""
train and test script for VED 1
author: G. Behrens
...
from cbrain.data_generator import DataGenerator
# transform vertical axis into pressure coords
...
with strategy.scope():
    ...
    outputs_A = Dense(104,activation='linear')(outputs_1) # use concat. output layer
    outputs_B = Dense(9,activation='relu')(outputs_1) # relu for positive defined fluxes
...
csv_logger = CSVLogger('real_geography/VEDs/VED_1/VED_1.csv')
...
# save VED model files 
np.save('real_geography/VEDs/VED_1/VED_1',test_mse)
VED.save_weights('real_geography/VEDs/VED_1/VED_1_weights.h5')
VED.save_weights('real_geography/VEDs/VED_1/VED_1.tf')
VED.save_model('real_geography/VEDs/VED_1/VED_1_model.h5')
