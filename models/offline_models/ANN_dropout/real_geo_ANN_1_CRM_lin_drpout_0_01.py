"""
training and  test mse of ANN-dropout
...
with strategy.scope():
    ...
    Drpout_1=Dropout(0.01,input_shape=(intermediate_dim,))(x_3)
    outputs_1= Dense(original_dim_output,activation='elu')(Drpout_1)
...
csv_logger = CSVLogger('real_geography/ANNs/ANN_1/ANN_1_CRM_lin_dro_0_01.csv')
...
np.save('real_geography/ANNs/ANN_1/ANN_1_CRM_lin_dro_0_01',test_mse)
ANN.save_weights('real_geography/ANNs/ANN_1/ANN_1_CRM_lin_dro_0_01.h5')
ANN.save_weights('real_geography/ANNs/ANN_1/ANN_1_CRM_lin_dro_0_01.tf')

ANN.save('real_geography/ANNs/ANN_1/ANN_1_CRM_lin_dro_0_01_model.h5')
