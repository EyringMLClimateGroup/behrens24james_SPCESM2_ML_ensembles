"""
train and test script for ANN 7
author: G.Behrens
...
# load SPCESM raw data to transform vertical grid in pressure coords
...
def schedule(epoch):
    ...
    if epoch < 7:
        ...
        return 0.0004743755174101
    elif epoch < 14:
            
        return 0.0004743755174101/5

    elif epoch < 21:
            
        return 0.0004743755174101/25
        
    elif epoch < 28:
        return 0.0004743755174101/125
        
    elif epoch < 35:
        return 0.0004743755174101/625

    elif epoch<42:
        return 0.0004743755174101/3125

        
# save history
callback_lr=LearningRateScheduler(schedule,verbose=1)
csv_logger = CSVLogger('real_geography/ANNs/ANN_7/ANN_7_CRM_lin.csv')
...
# save model files
np.save('real_geography/ANNs/ANN_7/ANN_7_CRM_lin',test_mse)
ANN.save_weights('real_geography/ANNs/ANN_7/ANN_7_CRM_lin.h5')
ANN.save('real_geography/ANNs/ANN_7/ANN_7_CRM_lin_models.h5')

ANN.save_weights('real_geography/ANNs/ANN_7/ANN_7_CRM_lin.tf')
