...
#load SP raw data to determine pressure coords.
...
# load hybrid ai and hybrid bi to compute pressure
hybi=test_xr.hybi
hyai=test_xr.hyai
...
# defining training data (shuffled in space and time) consisting of first 7 consecutive days of each month of year 2013 of SPCESM2 simulation
...
with strategy.scope():
    ...
    outputs_1= Dense(original_dim_output,activation='elu')(x_3)
    ...
    # compile model with predefined batch size and lr
    ANN.compile(ke.optimizers.Adam(lr=0.0006165736875066469), loss=mse, metrics=['mse','mae','accuracy'])
...
def schedule(epoch):
    ...
    if epoch < 7:
        ...
        return 0.0006165736875066469
    elif epoch < 14:
            
        return 0.0006165736875066469/5

    elif epoch < 21:
            
        return 0.0006165736875066469/25
        
    elif epoch < 28:
        return 0.0006165736875066469/125
        
    elif epoch < 35:
        return 0.0006165736875066469/625

    elif epoch<42:
        return 0.0006165736875066469/3125
...
csv_logger = CSVLogger('real_geography/ANNs/ANN_1/ANN_1_CRM_lin.csv')
...
# save test_mse, history, model and model weights_and_biases_file --> necessary for online coupling

np.save('real_geography/ANNs/ANN_1/ANN_1_CRM_lin',test_mse)
ANN.save_weights('real_geography/ANNs/ANN_1/ANN_1_CRM_lin.h5')
ANN.save('real_geography/ANNs/ANN_1/ANN_1_CRM_lin_model.h5')
ANN.save_weights('real_geography/ANNs/ANN_1/ANN_1_CRM_lin.tf')
