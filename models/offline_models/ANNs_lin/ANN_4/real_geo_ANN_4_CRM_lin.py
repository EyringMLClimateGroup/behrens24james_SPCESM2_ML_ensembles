"""
train and test script for ANN 4
author: G.Behrens
"""
...
# load raw SPCESM data to determine pressure levels from vertical hybrid coords 
...
# build ANN with multi-GPU training
...
def schedule(epoch):
    ...
    if epoch < 7:
        ...
        return 0.0004723136556966778
    elif epoch < 14:
            
        return 0.0004723136556966778/5

    elif epoch < 21:
            
        return 0.0004723136556966778/25
        
    elif epoch < 28:
        return 0.0004723136556966778/125
        
    elif epoch < 35:
        return 0.0004723136556966778/625

    elif epoch<42:
        return 0.0004723136556966778/3125



        
        
# save traing and validation history
callback_lr=LearningRateScheduler(schedule,verbose=1)
csv_logger = CSVLogger('real_geography/ANNs/ANN_4/ANN_4_CRM_lin.csv')
...
# save model files
np.save('real_geography/ANNs/ANN_4/ANN_4_CRM_lin',test_mse)
ANN.save_weights('real_geography/ANNs/ANN_4/ANN_4_CRM_lin.h5')
ANN.save('real_geography/ANNs/ANN_4/ANN_4_CRM_lin_model.h5')

ANN.save_weights('real_geography/ANNs/ANN_4/ANN_4_CRM_lin.tf')
