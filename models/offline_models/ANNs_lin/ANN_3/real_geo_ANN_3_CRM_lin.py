"""
train and test script for ANN 3
...
# compute pressure levels of vertical axis based on SPCESM raw data
...
# defining training data (shuffled in space and time) consisting of first 7 consecutive days of each month of year 2013 of SPCESM simulation
...
# defining validation data consisting of first 7 consecutive days of each month of year 2014 of SPCESM simulations
...
with strategy.scope():
    ...
    x_6 =Dense(intermediate_dim, activation='elu')(x_5)
    x_7 =Dense(intermediate_dim, activation='elu')(x_6)

    outputs_1= Dense(original_dim_output,activation='elu')(x_7)
    ...
    # compile ANN
    ANN.compile(ke.optimizers.Adam(lr=0.0004818752100100116), loss=mse, metrics=['mse','mae','accuracy'])
...
def schedule(epoch):
    ...
    if epoch < 7:
        ...
        return 0.0004818752100100116
    elif epoch < 14:
            
        return 0.0004818752100100116/5

    elif epoch < 21:
            
        return 0.0004818752100100116/25
        
    elif epoch < 28:
        return 0.0004818752100100116/125
        
    elif epoch < 35:
        return 0.0004818752100100116/625

    elif epoch<42:
        return 0.0004818752100100116/3125



        
# get training history and save it        

callback_lr=LearningRateScheduler(schedule,verbose=1)
csv_logger = CSVLogger('real_geography/ANNs/ANN_3/ANN_3_CRM_lin.csv')
...
# save model files 
np.save('real_geography/ANNs/ANN_3/ANN_3_CRM_lin',test_mse)
ANN.save_weights('real_geography/ANNs/ANN_3/ANN_3_CRM_lin.h5')
ANN.save('real_geography/ANNs/ANN_3/ANN_3_CRM_lin_model.h5')

ANN.save_weights('real_geography/ANNs/ANN_3/ANN_3_CRM_lin.tf')
