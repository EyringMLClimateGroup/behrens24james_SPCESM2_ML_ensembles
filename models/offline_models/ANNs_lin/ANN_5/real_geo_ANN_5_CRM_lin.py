"""
train and test script for ANN 5
author: G.Behrens
"""
...
from cbrain.data_generator import DataGenerator
# compute pressure levsl of vertical grid
...
with strategy.scope():
    ...
    ANN.compile(ke.optimizers.Adam(lr=0.0012624743823402415), loss=mse, metrics=['mse','mae','accuracy'])
...
def schedule(epoch):
    ...
    if epoch < 7:
        ...
        return 0.0012624743823402415
    elif epoch < 14:
            
        return 0.0012624743823402415/5

    elif epoch < 21:
            
        return 0.0012624743823402415/25
        
    elif epoch < 28:
        return 0.0012624743823402415/125
        
    elif epoch < 35:
        return 0.0012624743823402415/625

    elif epoch<42:
        return 0.0012624743823402415/3125
...
csv_logger = CSVLogger('real_geography/ANNs/ANN_5/ANN_5_CRM_lin.csv')
...
# save model files
np.save('real_geography/ANNs/ANN_5/ANN_5_CRM_lin',test_mse)
ANN.save_weights('real_geography/ANNs/ANN_5/ANN_5_CRM_lin.h5')
ANN.save('real_geography/ANNs/ANN_5/ANN_5_CRM_lin_model.h5')

ANN.save_weights('real_geography/ANNs/ANN_5/ANN_5_CRM_lin.tf')
